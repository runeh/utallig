...
export const pnumControl1Multipliers = [3, 7, 6, 1, 8, 9, 4, 5, 2];
export const pnumControl2Multipliers = [5, 4, 3, 2, 7, 6, 5, 4, 3, 2];
...
export function getBirthDate(args: {
  randomFloat: RandomFloatFun;
  startYear: number;
  endYear: number;
...
export function getIndividualNumber(args: {
  randomFloat: RandomFloatFun;
  year: number;
  gender: 'f' | 'm';
}): number {
